...
class UR3_DoorHook(VecTask):
    ...
    def __init__(self, cfg, rl_device, sim_device, graphics_device_id, headless, virtual_screen_capture, force_render):
        ...
        # self.action_scale =  0.0 # left 0.4 # right_pull 0.4
        # self.action_scale =  0.0125 # left 0.4 # right_pull 0.4
        # self.action_scale =  0.0 # left 0.4 # right_pull 0.4
    ...
    def _create_envs(self, num_envs, spacing, num_per_row):
        ...
        door_2_asset_file = 'urdf/door_test/door_2_inv_wall_2.urdf'
        ...
        ur3_dof_stiffness = to_torch([15000, 15000, 15000, 15000, 15000, 15000, 15000], dtype=torch.float, device=self.device)
        # ur3_dof_damping = to_torch([400, 400, 400, 400, 400, 400, 400], dtype=torch.float, device=self.device)  # left
        ur3_dof_damping = to_torch([500 for _ in range(self.num_ur3_dofs)], dtype=torch.float, device=self.device)   # right
        ...
        self.handle_torque_tensor[:,self.num_ur3_dofs+1] = -15
        ...
        for i in range(self.num_envs):
            ...
            ####################################################################################################
            self.gym.set_actor_scale(env_ptr, door_actor, self.door_scale_param)
    ...
    def reset_idx(self, env_ids):
        ...
        self.ur3_dof_pos[env_ids, :] = self.ur3_default_dof_pos
        self.ur3_dof_vel[env_ids, :] = torch.zeros_like(self.ur3_dof_vel[env_ids])
        self.ur3_dof_targets[env_ids, :self.num_ur3_dofs] = self.ur3_default_dof_pos
