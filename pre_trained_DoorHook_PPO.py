...
# NW 4_1
        ...
        self.d_feture_extractor = torch.load('../../depthnet/logs/2024-01-15 13:51:14.804368/encoder105.pt', map_location=self.device)
...
class DoorHookTrainer(PPOnet):
    ...
    def eval(self, load_path=None):
        ...
        self.cfg_trainer = {"timesteps": 1000000, "headless": False}
        self.trainer = SequentialTrainer(cfg=self.cfg_trainer, env=self.env, agents=self.agent)
